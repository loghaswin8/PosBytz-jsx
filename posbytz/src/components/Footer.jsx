const Footer = ({ footerData }) => {
    ...
    return (
        <section className="w-full h-[570px] bg-[#07112D] flex flex-col items-center text-white">
            {/* Top Section */}
            <section id="Top section" className="w-full grid grid-cols-4 gap-8 pl-[100px] pt-[40px]">
                <div>
            ...
            {/* Bottom Section */}
            <section id="bottom section" className="w-full grid grid-cols-3 gap-8 pl-[420px] pt-[40px]">
                {footerData.slice(3).map((section, index) => (
                    <div key={index}>
                        <span className="font-normal">{section.heading}</span>
                        {section.heading === "FIND US ON" ? (
                            <div id="media-icons" className="grid grid-cols-3 gap-4 mt-4">
                ...
                <div className="relative flex flex-col items-center mt-4 w-full">
                    <hr className="w-[170vh] border-t border-gray-300 absolute left-1/2 transform -translate-x-1/3 ml-[-90px]" />
                    <span className="mt-2 text-gray-500 relative left-[550px] transform translate-x-1/2">@2023 Bytize</span>
                </div>
